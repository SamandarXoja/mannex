                    ...
                    <div className="flex ">
                        ...
                        <div className="flex  items-center">
                            <button className="cart flex items-center gap-[16px] relative mr-[36px]">
                                <Link className="flex gap-[22px]" href={'/cart'}><ShoppingCart color="#4BA9FF" />
                            ...
                            <button className="action_btn font-bold flex items-center justify-center  text-[16px] border border-[#4BA9FF] text-[#4BA9FF]  w-[83px] min-h-[40px]">
